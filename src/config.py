...
SWORK_API_KEY = env.get('SWORK_API_KEY')
SWORK_SHOP_ID = env.get('SWORK_SHOP_ID')
SWORK_API_URL = env.get('SWORK_API_URL')
DOMAIN_BASE_URL = env.get('DOMAIN_BASE_URL')
DOMAIN_API_KEY = env.get('DOMAIN_API_KEY')
